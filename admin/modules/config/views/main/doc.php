...
<head>
    ...
    <title>管理后台 API文档</title>

</head>
<body>
<h1>管理后台 API文档</h1>

<link href="//cdn.bootcss.com/highlight.js/9.10.0/styles/googlecode.min.css" rel="stylesheet">
...
<ul>
    <li>V1.10----- 2017-05-19 <code>添加管理后台 API文档</code> </li>
</ul>
...
<blockquote><ol>
    <li>接口所有交互数据采用utf8编码，非utf8编码数据会被拒绝.</li>
    <li>返回示例中，content只展示整体结构，具体的对象字段，请参考ssdb文档.</li>
</ol>
</blockquote>
